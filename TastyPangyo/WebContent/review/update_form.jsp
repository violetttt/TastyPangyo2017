...
<style type="text/css">
.kostar-input>.input,
.kostar-input>.input>label:hover,
.kostar-input>.input>input:focus+label,
.kostar-input>.input>input:checked+label{
...
.kostar-input>.input>input{
    position: absolute;
    width: 1px;
    height: 1px;
    opacity: 0;
}
.kostar-input>.input.focus{
    outline: 1px dotted #ddd;
}
.kostar-input>.input>label{
    width: 10px;
    height: 0;
    padding: 19px 0 0 0;
    overflow: hidden;
...
.kostar-input>.input>label:hover~label{
    background-image: none;
}
.kostar-input>.input>label[for="p1"]{ 
    width: 10px;
    z-index: 10;
}
.kostar-input>.input>label[for="p2"]{ 
    width: 20px;
    z-index: 9;
}
.kostar-input>.input>label[for="p3"]{ 
    width: 30px;
    z-index: 8;
}
.kostar-input>.input>label[for="p4"]{ 
    width: 40px;
    z-index: 7;
}
.kostar-input>.input>label[for="p5"]{ 
    width: 50px;
    z-index: 6;
}
.kostar-input>.input>label[for="p6"]{ 
    width: 60px;
    z-index: 5;
}
.kostar-input>.input>label[for="p7"]{ 
    width: 70px;
    z-index: 4;
}
.kostar-input>.input>label[for="p8"]{ 
    width: 80px;
    z-index: 3;
}
.kostar-input>.input>label[for="p9"]{ 
    width: 90px;
    z-index: 2;
}
.kostar-input>.input>label[for="p10"]{ 
    width: 100px;
    z-index: 1;
}
.kostar-input>output{
