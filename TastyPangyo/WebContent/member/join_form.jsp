...
<div id="div_root">
	...
	<div id="div_menu">
		<ul id="nav">
			...
			<li><a href="/TastyPangyo/restaurant/user_select_result.jsp">
					전체맛집조회 </a></li>
			<li><a href="/TastyPangyo/restaurant/user_selectByLocation.jsp">
					건물로조회</a></li>
			<li><a href="/TastyPangyo/restaurant/user_selectByName_form.jsp">
					이름으로조회 </a></li>
			<li><a
				href="/TastyPangyo/restaurant/user_selectByCategory_form.jsp">
					카테고리로조회</a></li>
